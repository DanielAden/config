...
-- Makes paren matching look better.  Only tested with the "desert" theme,
-- not sure how it will look with others...
vim.api.nvim_create_autocmd("ColorScheme", {
	callback = function()
		vim.cmd([[hi MatchParen guibg=grey30 guifg=#dfffdf]])
	end,
})
